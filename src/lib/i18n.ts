...
const he = {
  ...
  waLead:
    "בחרו מגדלים, נסחו הודעה, ושלחו אחד־אחד. כל שיחה נפתחת עם הנוסח שלו. היו מחוברים לוואטסאפ העסקי לפני השליחה.",
  waPhoneLabel: "מספר וואטסאפ עסקי",
  waPhoneHint:
    "זה המספר שממנו אתם מחוברים ב־WhatsApp. המגדלים יראו אותו כשולח.",
...
const ar: { [K in keyof typeof he]: string } = {
  ...
  waLead:
    "اختاروا مربّين، اكتبوا النص، وأرسلوا واحدًا تلو الآخر. كل محادثة تُفتح بنصّه. ابقوا متصلين بواتساب العمل قبل الإرسال.",
  waPhoneLabel: "رقم واتساب التجاري",
  waPhoneHint:
    "هذا الرقم المتصل في واتساب. سيراه المربّون كمرسل.",
