...
const he = {
  ...
  groupName: "שם הקבוצה",
  searchNumber: "חיפוש לפי מספר בטבלה",
  animalNumber: "מספר",
  sex: "מין",
  sexMale: "זכר",
  sexFemale: "נקבה",
  ...
  herdAllCount: "{count} חיות בעדר",
  emptyGroups: "קבוצות בלי חיות",
  ...
  sortByPregnant: "מיון לפי הריון",
  sortByLambing: "מיון לפי המלטה",
  sortByGene: "מיון לפי גן",
  vaccineBulkTitle: "חיסון לפי מספרים",
  vaccineBulkLead: "הזינו מספרים והקישו אישור. אפשר גם לחסן כל חיה בשורה.",
  vaccineBulkPlaceholder: "למשל 4 7 15 199",
  ...
  pregnancyTitle: "הריון",
  spongeDate: "ספוג",
  hormoneDate: "הורמון",
  matingDate: "זיווג/הזרעה",
  lambingDate: "תאריך המלטה",
  lambingHistory: "היסטוריית המלטות",
  addLambing: "הוספת המלטה",
  lambingBorn: "נולדו",
  lambingAlive: "חיים",
  lambingNote: "הערה",
  lambingSummary: "{lambings} המלטות · {born} ולדות · {perYear} לשנה",
  lambingAvg: "ממוצע להמלטה: {avg}",
  lambingYearLine: "{year}: {born} ולדות",
  noLambings: "אין עדיין המלטות לנקבה זו",
  deleteLambing: "מחיקת המלטה",
  confirmDeleteLambing: "למחוק את ההמלטה מתאריך {date}?",
  errLambingFuture: "תאריך ההמלטה לא יכול להיות בעתיד",
  errLambingCounts: "מספר החיים לא יכול להיות גדול ממספר הנולדים",
  treatmentsTitle: "מחלות וטיפולים",
  treatmentsField: "מחלות וטיפולים",
  noTreatments: "אין עדיין תיעוד",
  treatmentCount: "{count} רשומות",
  addTreatment: "הוספת תיעוד",
  editTreatment: "עריכה",
  deleteTreatment: "מחיקה",
  confirmDeleteTreatment: "למחוק את התיעוד הזה?",
  treatmentPlaceholder: "מחלה, טיפול, תרופה או הערה...",
  authorVet: "ווטרינר",
  authorBreeder: "מגדל",
  treatmentEdited: "עודכן",
  closeTreatments: "סגירה",
  checkup1Date: "בדיקה ראשונה",
  checkup2Date: "בדיקה שנייה",
  ...
  eventSponge: "ספוג",
  eventHormone: "הורמון",
  eventMating: "זיווג/הזרעה",
  eventLambing: "תאריך המלטה",
  eventCheckup1: "בדיקה ראשונה",
  eventCheckup2: "בדיקה שנייה",
  ...
  vaccineLifetime: "חד פעמי",
  vaccineLifetimeUntil: "תקף לעד",
...
const ar: { [K in keyof typeof he]: string } = {
  ...
  searchNumber: "بحث حسب الرقم في الجدول",
  animalNumber: "الرقم",
  sex: "الجنس",
  sexMale: "ذكر",
  sexFemale: "أنثى",
  ...
  geneType: "نوع الجين",
  geneTypeChoose: "اختاروا نوع الجين",
  age: "العمر",
  pregnant: "حمل",
  pregnantYes: "حامل",
  ...
  herdAllCount: "{count} حيوانات في القطيع",
  emptyGroups: "مجموعات بلا حيوانات",
  ...
  sortByPregnant: "ترتيب حسب الحمل",
  sortByLambing: "ترتيب حسب الولادة",
  sortByGene: "ترتيب حسب الجين",
  vaccineBulkTitle: "تطعيم حسب الأرقام",
  vaccineBulkLead: "أدخلوا أرقامًا ثم اضغطوا موافقة. يمكن أيضًا تطعيم كل حيوان في صفّه.",
  vaccineBulkPlaceholder: "مثلًا 4 7 15 199",
  ...
  spongeDate: "إسفنجة",
  hormoneDate: "هرمون",
  matingDate: "تزاوج/تلقيح",
  lambingDate: "تاريخ الولادة",
  lambingHistory: "سجل الولادات",
  addLambing: "إضافة ولادة",
  lambingBorn: "وُلدوا",
  lambingAlive: "أحياء",
  lambingNote: "ملاحظة",
  lambingSummary: "{lambings} ولادات · {born} مواليد · {perYear} في السنة",
  lambingAvg: "معدل لكل ولادة: {avg}",
  lambingYearLine: "{year}: {born} مواليد",
  noLambings: "لا ولادات لهذه الأنثى بعد",
  deleteLambing: "حذف الولادة",
  confirmDeleteLambing: "حذف الولادة بتاريخ {date}؟",
  errLambingFuture: "تاريخ الولادة لا يمكن أن يكون في المستقبل",
  errLambingCounts: "عدد الأحياء لا يمكن أن يكون أكبر من عدد المواليد",
  treatmentsTitle: "أمراض وعلاجات",
  treatmentsField: "أمراض وعلاجات",
  noTreatments: "لا توثيق بعد",
  treatmentCount: "{count} سجلات",
  addTreatment: "إضافة توثيق",
  editTreatment: "تعديل",
  deleteTreatment: "حذف",
  confirmDeleteTreatment: "حذف هذا التوثيق؟",
  treatmentPlaceholder: "مرض، علاج، دواء أو ملاحظة...",
  authorVet: "طبيب بيطري",
  authorBreeder: "مربٍّ",
  treatmentEdited: "عُدِّل",
  closeTreatments: "إغلاق",
  checkup1Date: "الفحص الأول",
  checkup2Date: "الفحص الثاني",
  ...
  eventSponge: "إسفنجة",
  eventHormone: "هرمون",
  eventMating: "تزاوج/تلقيح",
  eventLambing: "تاريخ الولادة",
  eventCheckup1: "الفحص الأول",
  eventCheckup2: "الفحص الثاني",
  ...
  vaccineLifetime: "لمرة واحدة",
  vaccineLifetimeUntil: "ساري للأبد",
